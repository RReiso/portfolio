        ...
        <div className=" md:w-2/3 bg-white flex flex-col md:pl-20 md:pt-12 p-5">
          ...
          <div className="flex">
            ...
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="border text-gray-700 border-2 hover:text-white hover:bg-pink-600 mt-10 w-34 ml-1 font-bold py-2 px-4 rounded-lg mt-3 transition ease-in-out duration-300 text-center focus:ring-4 focus:ring-pink-800 focus:outline-none"
            >
              My Resume
            </a>
          </div>
