...
const Home = () => {
  return (
    <section id="home" className="md:h-screen">
      ...
      <div className="mt-10 py-5 md:py-0 flex px-4 flex-col md:flex-row rounded-xl p-3 max-w-xs md:max-w-4xl mx-auto bg-white">
        ...
        <div className=" md:w-2/3 bg-white flex flex-col md:pl-20 md:pt-12 p-5">
          ...
          <div className="flex">
            <a
              ...
              href="#contact"
              className="mt-10 w-30 bg-pink-600 border-2 border-pink-600 hover:border-2 0 hover:text-gray-700 hover:bg-white text-white font-bold py-2 px-5 rounded-lg mt-3 transition ease-in-out duration-300 text-center mr-1 focus:ring-4 focus:ring-pink-800 focus:outline-none"
            >
              Let's talk
            </a>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="border text-gray-700 border-2 border-[#DD1155] hover:text-white hover:bg-pink-600 mt-10 w-34 ml-1 font-bold py-2 px-4 rounded-lg mt-3 transition ease-in-out duration-300 text-center focus:ring-4 focus:ring-pink-800 focus:outline-none"
            >
              My Resume
            </a>
          </div>
